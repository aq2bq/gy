...
If the ledger holds no decision on how to work together, ask these once before any work, briefly and with the choices, and record the answers with `decide`. If they change their mind later, accept it and record a decision that supersedes the old one.
