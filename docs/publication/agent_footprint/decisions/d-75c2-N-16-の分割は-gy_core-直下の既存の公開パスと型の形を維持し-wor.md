...
crates/gy-core の lib.rs は mod workflow と pub use workflow::* のまま。下流の gy_core::RecordSchema 等の import と型の形は d334001 と同一。公開 API の追加は含めない（Rust 公開 API は 0.4.0 と互換、z の変更）。
