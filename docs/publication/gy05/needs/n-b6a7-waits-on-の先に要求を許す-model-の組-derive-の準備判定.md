...
- 事実で閉じた（2026-09-15 lead が検収。measure gy-ledger 違反 0（score 140）、gy-migrate は legacy/ の文字列キーのみ。テスト 191 件 0 failed。Kokopelli の写し（74fa00f、356 ノード）で waits-on 17（要求待ち 1 + belongs-to 10 + 元の 6）、skipped 0、next が 0.4 と同じ 6 件（N-1 / N-4 / N-11 / N-15 / N-23 / N-25）。コミット b86c2e9）
