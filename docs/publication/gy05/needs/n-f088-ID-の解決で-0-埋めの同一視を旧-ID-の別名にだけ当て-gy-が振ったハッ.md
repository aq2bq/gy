...
- 事実で閉じた（2026-09-15 lead が検収。measure 違反 0（score 83）、テスト 0 failed。Kokopelli の台帳（読むだけ）で show D-8 が d-43e5、show d-0008 が d-0008、show D-08 が d-43e5。コミット 96dcfd3、ローカルにインストール）
