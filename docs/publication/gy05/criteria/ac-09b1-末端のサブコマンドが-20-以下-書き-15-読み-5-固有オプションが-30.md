...
- satisfied（2026-09-15 lead。gy5 の末端は 20（書き 15: need add / close、question add / close、decide、req add / approve / revise / done / cancel、criterion add / satisfy、link、edit、undo。読み 5: show、list、next、handover、publish）、固有オプションは distinct 30（N-64 の測定、--relate 化後）。D-84 で改めた数のとおり。定型 9 つ（要求化の着手、起票、決定の採番、確定、改訂、完了、中止、論点を事実で閉じる、受け入れ条件の充足）はそれぞれ 1 コマンド） 2026-09-15T04:09:00.967811+00:00
