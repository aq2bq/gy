...
Graph titles wrap below their IDs for up to three lines; only longer titles are shortened. The table and detail heading retain full titles. Ordinary individual views fit their measured labels into the graph; Lineage preserves readable generation layout and pan access to off-screen records.
