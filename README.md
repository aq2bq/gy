...
The initial command set, including requirement compression, is implemented. The crates have not been published to crates.io.
...
After publication, the installation command will be `cargo install gy --locked`. Publication has not yet taken place.
